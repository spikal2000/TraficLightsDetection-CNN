...
detected_boxes = detect_traffic_signs(image_rgb)

# Draw the bounding boxes on the image and show the predicted class label
for box in detected_boxes:
    ...
    cv2.putText(image_rgb, label, (text_x, text_y), font, font_scale, (0, 0, 0), font_thickness)
